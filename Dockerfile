...
COPY --from=build /src/target/x86_64-unknown-linux-musl/release/http-switchboard /usr/local/bin/http-switchboard
COPY --from=build --chown=65532:65532 /state /var/lib/http-switchboard
USER 65532:65532
