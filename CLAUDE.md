...
| Field | Value |
|---|---|
| Current phase | **Phase 6/9 · chassis 1.8.0 round** (2026-09-09) |
| Last completed gate | Adoption form of 2026-09-09: H1 · V1 · T1 · D1 all Onmisbaar, C1 Klopt. Built: the inbound door on kit client tokens, the Profiles section + Recheck button, the kit test harness for the door suite, `docs/KIT.md` references, the README correction with its test |
| Next gate | the 3.0.0 release report — Kenny's go, then the signature. **The deploy on CT 109 is the Homelab Rust session's (V6)** and needs the two new secrets first: `docs/HANDOVER_HOMELAB.md` |
| AFK mode | off |
